...
function SearchForm() {
  const result = localStorage.getItem("moviesSearch")
  const checkbox = localStorage.getItem("moviesCheckbox")

  const resultRef = React.useRef();

  function handleCheckbox() {
    (checkbox === "true") ? localStorage.setItem("moviesCheckbox", false) : localStorage.setItem("moviesCheckbox", true);
  }
  ...
  function coverResult(e) {
    ...
    localStorage.setItem("moviesSearch", resultRef.current.value )
    console.log(localStorage.getItem("moviesSearch"))
  }
  
  return (
    <form className="search-form" onSubmit={(e)=>{coverResult(e)}}>
      <div className="search-form__logo">
        <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path fill-rule="evenodd" clip-rule="evenodd" d="M18.7927 18.2634C17.3608 19.6953 15.0391 19.6953 13.6072 18.2634C12.1753 16.8315 12.1753 14.5099 13.6072 13.078C15.0391 11.646 17.3608 11.646 18.7927 13.078C20.2246 14.5099 20.2246 16.8315 18.7927 18.2634ZM19.2331 19.6464C17.2728 21.1458 14.4572 20.999 12.6644 19.2062C10.7118 17.2536 10.7118 14.0878 12.6644 12.1351C14.617 10.1825 17.7829 10.1825 19.7355 12.1351C21.5282 13.9279 21.675 16.7433 20.1758 18.7035L23.7425 22.2702L22.7997 23.213L19.2331 19.6464Z" fill="#959595"/>
        </svg>
      </div>
      <div className="search-form__fieldset">
        <input 
          ...
          type="text"
        />
        <button className="search-form__search" type="submit">
