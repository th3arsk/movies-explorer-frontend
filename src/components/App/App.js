...
function App() {
  ...
  const filteredMovies = useFilter(movies, localStorage.getItem("moviesSearch"), localStorage.getItem("moviesCheckbox"), loggedIn);
  const filteredSavedMovies = useFilter(savedMovies, localStorage.getItem("savedMoviesSearch"), localStorage.getItem("savedMoviesCheckbox"), loggedIn);
