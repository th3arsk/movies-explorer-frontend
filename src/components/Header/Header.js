...
function Header(props) {
  return (
    <header className={`header ${ props.light ? "" : "header_dark"}`}>
      ...
      <div className="header__nav">
        { props.isLoggedIn ?
          <Navigation 
            light={props.light}
            moviesOpened={props.moviesOpened}
            savedMoviesOpened={props.savedMoviesOpened} 
            mainOpened={props.mainOpened}
          />
          : 
          <nav className="header__register">
            <Link className="header__sign-up" to="/signup">Регистрация</Link>
